...
void can_transmit(void)
{
	...
	TXB0D0 = data1[0];			/* DataByte 0 */
	TXB0D1 = data1[1];			/* DataByte 1 */
	TXB0D2 = data1[2];			/* DataByte 2 */
	TXB0D3 = data1[3];			/* DataByte 3 */
	TXB0D4 = data2[0];			/* DataByte 4 */
	TXB0D5 = data2[1];			/* DataByte 5 */
	TXB0D6 = data2[2];			/* DataByte 6 */
	TXB0D7 = data2[3];			/* DataByte 7 */
