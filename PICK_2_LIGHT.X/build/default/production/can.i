...
void can_transmit(void)
{
 ...
 TXB0DLC = 0x08;
 TXB0D0 = read_internal_eeprom(0x10)+48;
 TXB0D1 = read_internal_eeprom(0x11)+48;
 TXB0D2 = read_internal_eeprom(0x12)+48;
 TXB0D3 = read_internal_eeprom(0x13)+48;
 TXB0D4 = read_internal_eeprom(0x21)+48;
 TXB0D5 = read_internal_eeprom(0x22)+48;
 TXB0D6 = read_internal_eeprom(0x23)+48;
 TXB0D7 = read_internal_eeprom(0x24)+48;
